    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                    ...
                    .authorizeHttpRequests(authorizationManagerRequestMatcherRegistry -> {
                        ...
                        authorizationManagerRequestMatcherRegistry.requestMatchers("/static/js/**").permitAll();
                        authorizationManagerRequestMatcherRegistry.requestMatchers("/static/css/**").permitAll();
